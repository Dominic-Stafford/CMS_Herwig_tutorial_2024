...
externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/eos/user/d/dstaffor/CMS_Herwig_tutorial_24_gridpacks/DY_NLO_inclusive_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
...
generator = cms.EDFilter("Herwig7HadronizerFilter",
    ...
    process_settings = ('set /Herwig/EventHandlers/EventHandler:CascadeHandler:MPIHandler NULL'),                                                                                                                                
...
rivetAnalyzer.OutputFile = cms.string("NLO_MG_lhe_DY.yoda")
